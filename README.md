...
- [To do list website live link](https://fevenseyfu.github.io/Todo-List-app/)
...
- Step 2: Once you have installed git you can clone this project using the command below:
  ```
  git clone https://github.com/FevenSeyfu/Todo-List-app.git
  ```
...
I would like to thank my teammates and code reviewers, for their constructive feedback.
